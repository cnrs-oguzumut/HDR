...
\begin{frame}{Non-linear phenomena}
    \begin{center}
        \textbf{Crystals}\\[0.1cm]
        \includegraphics[height=3.5cm]{Figures/crystal.pdf}
        \hfill
        \includegraphics[height=3.5cm]{Figures/amorphous.pdf}
        
        \vfill
        \hrule
        \vfill

        \textbf{Meta-materials}\\[0.1cm]
        \includegraphics[height=2.2cm]{Figures/Page3_Fig1.png}
        \hfill
        \includegraphics[height=2.2cm]{Figures/Page5_Fig1.png}
    \end{center}
\end{frame}
