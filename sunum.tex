...
\begin{frame}{Non-linear phenomena}
    \begin{center}
        ...
        \includegraphics[height=3.1cm]{Figures/crystal.pdf}
        \hfill
        \includegraphics[height=3.1cm]{Figures/amorphous.pdf}
        ...
        \includegraphics[height=1.8cm]{Figures/Page3_Fig1.png}
        \hfill
        \includegraphics[height=1.8cm]{Figures/Page5_Fig1.png}
    \end{center}
\end{frame}
