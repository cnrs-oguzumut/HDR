    ...
    \begin{block}{Meta-materials}
        \begin{columns}[c, onlytextwidth]
            \column{0.48\textwidth}
                \centering\includegraphics[width=\textwidth,height=1.5cm,keepaspectratio]{Figures/Page3_Fig1.png}
            \column{0.48\textwidth}
                \centering\includegraphics[width=\textwidth,height=2.0cm,keepaspectratio]{Figures/Page5_Fig1.png}
        \end{columns}
    \end{block}
\end{frame}
