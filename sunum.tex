...
\begin{frame}{Non-linear phenomena}
    \vspace{-0.2cm}
    % --- TOP ROW: Crystals ---
    \begin{block}{Crystals}
        \begin{columns}[c]
            \column{0.48\textwidth}
                \centering\includegraphics[width=\textwidth,height=2.5cm,keepaspectratio]{Figures/crystal.pdf}
            \column{0.48\textwidth}
                \centering\includegraphics[width=\textwidth,height=2.5cm,keepaspectratio]{Figures/amorphous.pdf}
        \end{columns}
    \end{block}
    ...
    \begin{block}{Meta-materials}
        \begin{columns}[c]
            ...
            \column{0.48\textwidth}
                \centering\includegraphics[width=\textwidth,height=2.2cm,keepaspectratio]{Figures/Page5_Fig1.png}
        \end{columns}
    \end{block}
\end{frame}
